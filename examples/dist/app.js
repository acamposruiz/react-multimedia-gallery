...
var _reactMultimediaGallery = require('react-multimedia-gallery');

var _reactMultimediaGallery2 = _interopRequireDefault(_reactMultimediaGallery);
...
var App = (function (_React$Component) {
    ...
    _createClass(App, [{
        ...
        value: function loadMorePhotos(e) {
            ...
            _jquery2['default'].ajax({
                ...
                success: (function (data) {
                    ...
                    var articles = Array(1, 1, 1).map(function (item) {
                        return { type: 'article', content: (0, _loremIpsum2['default'])({ count: 10, units: 'sentences' }) };
                    });
                    var videos = Array(Array('jlNvOWDfMYo', 'iRXJXaLV0n4', 'geqVuYmo8Y0', 'tntOCGkgt98'), Array('1demxrg1pXE', 'DK9JIaokhc0', 'IrdYueB9pY4', 'sgiR7blUDA8'), Array('Mq0yEI_xpb8', 'Ec7gzVZv0', 'shluYa5WDUQ', 'hY7m5jjJ9mM'), Array('4a0FbQdH3dY', 'cfnXs03FA5s', 'IX7pdpm1gp8', 'QFH747sK200'))[_this.state.page].map(function (youtubeId) {
                        return {
                            ...
                            type: 'video',
                            content: youtubeId,
                            srcset: ['https://i1.ytimg.com/vi/' + youtubeId + '/maxresdefault.jpg 1024w', 'https://i1.ytimg.com/vi/' + youtubeId + '/sddefault.jpg 800w', 'https://i1.ytimg.com/vi/' + youtubeId + '/G0wGs3useV8.jpg 500w', 'https://i1.ytimg.com/vi/' + youtubeId + '/G0wGs3useV8.jpg 320w'],
                            sizes: ['(min-width: 480px) 50vw', '(min-width: 1024px) 33.3vw', '100vw']
                        };
                    });
                    ...
                    _this.setState({
                        ...
                        videos: _this.state.videos ? _this.state.videos.concat(videos) : videos,
                        items: _this.state.items ? _this.state.items.concat(items) : items,
        ...
        key: 'openLightbox',
        value: function openLightbox(index, event, typeItem) {
            event.preventDefault();

            this.setState({
                itemsLightbox: {
                    type: typeItem == 'photos' ? 'images' : typeItem == 'articles' ? 'texts' : 'videos',
                    items: typeItem == 'photos' ? this.state[typeItem] : this.state[typeItem].map(function (item) {
                        return item.content;
                    })
                },
                currentItem: index,
        ...
        value: function renderGallery() {
            ...
            return _react2['default'].createElement(
                ...
                function (_ref3) {
                    ...
                    return _react2['default'].createElement(_reactMultimediaGallery2['default'], { items: _this2.state.items, cols: cols, onClickItem: _this2.openLightbox });
                }
            );
        }
    }, {
...
},{"jquery":5,"lodash":6,"lorem-ipsum":8,"react":undefined,"react-dom":undefined,"react-images-texts-videos":undefined,"react-measure":20,"react-multimedia-gallery":undefined}],2:[function(require,module,exports){
"use strict";
...
},{"./emptyFunction":2,"_process":11}],5:[function(require,module,exports){
/*!
...
},{"./dictionary":7,"os":10}],9:[function(require,module,exports){
/*
object-assign
(c) Sindre Sorhus
@license MIT
...
},{"./lib/ReactPropTypesSecret":16,"_process":11,"fbjs/lib/invariant":3,"fbjs/lib/warning":4}],13:[function(require,module,exports){
/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
 * This source code is licensed under the MIT license found in the
...
},{"./lib/ReactPropTypesSecret":16,"fbjs/lib/emptyFunction":2,"fbjs/lib/invariant":3}],14:[function(require,module,exports){
(function (process){
/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
...
},{"./checkPropTypes":12,"./lib/ReactPropTypesSecret":16,"_process":11,"fbjs/lib/emptyFunction":2,"fbjs/lib/invariant":3,"fbjs/lib/warning":4,"object-assign":9}],15:[function(require,module,exports){
(function (process){
/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
...
},{"./with-content-rect":21,"react":undefined}],18:[function(require,module,exports){
'use strict';
...
},{"./Measure":17,"./with-content-rect":21}],21:[function(require,module,exports){
'use strict';
...
module.exports = exports['default'];
},{"./get-content-rect":18,"./get-types":19,"prop-types":15,"react":undefined,"resize-observer-polyfill":22}],22:[function(require,module,exports){
(function (global, factory) {
